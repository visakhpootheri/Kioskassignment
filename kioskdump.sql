...
CREATE TABLE `tblsurvey` (
  ...
  `txt1Qnrating` varchar(40) DEFAULT NULL,
  `txt2Qnrating` varchar(40) DEFAULT NULL,
  `txt3Qnrating` varchar(40) DEFAULT NULL,
  `txt4Qnrating` varchar(40) DEFAULT NULL,
  `txtfeedback` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Userid`)
...
-- Dump completed on 2023-02-25 10:07:41
